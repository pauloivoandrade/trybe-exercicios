...
// com a classe 'tech'. const input = document.getElementById('input');
const element = document.querySelector("#first-li")
input.addEventListener('input', (event) => {
valueChange = event.target.value;

element.innerText = valueChange;
})
...
myWebpage.addEventListener("dblclick", (redirecionar) => {
    myWebpage.innerHTML = window.open(src = "https://github.com/pauloivoandrade?tab=repositories")
...
myWebpage.addEventListener("mouseover", () => {
    myWebpage.style.color = 'lightblue';
})
